...
class TestNestedSingleObjectExtraction:
    ...
    @pytest.mark.asyncio
    @pytest.mark.unit
    async def test_nested_studio_extracted_and_cached(
    ...
    @pytest.mark.asyncio
    @pytest.mark.unit
    async def test_nested_studio_with_none_value(
        self, respx_stash_client, respx_mock: respx.MockRouter
    ) -> None:
...
class TestIdentityMapSingleObjects:
    ...
    @pytest.mark.asyncio
    @pytest.mark.unit
    async def test_identity_map_mutation_propagates(
        self, respx_stash_client, respx_mock: respx.MockRouter
    ) -> None:
...
class TestNestedListObjectExtraction:
    ...
    @pytest.mark.asyncio
    @pytest.mark.unit
    async def test_empty_performers_list_handled(
        self, respx_stash_client, respx_mock: respx.MockRouter
    ) -> None:
...
class TestStoreContextInjection:
    ...
    @pytest.mark.asyncio
    @pytest.mark.unit
    async def test_no_extraction_without_store_context(
        ...
        # Studio should be a Studio instance (or dict)
        # But it should NOT be in the store cache
        assert not store.is_cached(Studio, "st1")
...
class TestDeeplyNestedExtraction:
    ...
    @pytest.mark.asyncio
    @pytest.mark.unit
    async def test_nested_studio_with_parent_studio(
        self, respx_stash_client, respx_mock: respx.MockRouter
    ) -> None:
...
class TestReceivedFieldsWithNestedExtraction:
    ...
    @pytest.mark.asyncio
    @pytest.mark.unit
    async def test_nested_studio_has_received_fields(
        self, respx_stash_client, respx_mock: respx.MockRouter
    ) -> None:
