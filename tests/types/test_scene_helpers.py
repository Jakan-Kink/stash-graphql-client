...
class TestSceneHelperMethods:
    ...
    async def test_remove_from_gallery(self):
        ...
        await scene.remove_from_gallery(gallery)
    ...
    @pytest.mark.asyncio
    async def test_set_studio(self):
        ...
        # Set studio (sync method - simple field assignment)
    ...
    def test_helpers_are_async_not_sync(self):
        ...
        assert inspect.iscoroutinefunction(scene.add_to_gallery)
        assert inspect.iscoroutinefunction(scene.remove_from_gallery)
        assert inspect.iscoroutinefunction(scene.add_performer)
        assert inspect.iscoroutinefunction(scene.remove_performer)
        assert inspect.iscoroutinefunction(scene.add_tag)
        assert inspect.iscoroutinefunction(scene.remove_tag)
        # set_studio is sync (simple field assignment)
